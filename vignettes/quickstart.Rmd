...
```{r volcano, fig.width=7, fig.height=5, eval=FALSE}
mx_volcano(meta_result, label_top = 10)
```

```{r forest, fig.width=6, fig.height=4, eval=FALSE}
...
```{r heterogeneity, fig.width=6, fig.height=4, eval=FALSE}
